...
|----|-----|------|---------|----------|--------|
| D1 | CRIT | Motion | Hero copy linear premature fade = double-exposure bug feel | loop-01/before/scroll-15.png | OPEN |
| D2 | CRIT | Motion/AD | Temple exits viewport by 15%; 15–50% dead zone | loop-01/before/scroll-15/30/50.png | OPEN |
| D3 | HIGH | Reference | Floating glyph + orphan red bar = hologram cliché | loop-01/before/desktop-2560-settled.png | OPEN |
| D4 | HIGH | 3D | Uniform column rhythm; 2560 left-edge clip | loop-01/before/desktop-2560-settled.png | OPEN |
| D5 | HIGH | Reference | Creamy dais + salmon ring ≠ ceremonial lacquer floor | loop-01/before/scroll-15.png | OPEN |
